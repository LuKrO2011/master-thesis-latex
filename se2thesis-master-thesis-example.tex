...
%	\lstinputlisting[language=Java, firstline=8, lastline=29, caption={The same example modified to be badly readable},label={lst:cassandra-src-java-org-apache-cassandra-utils-modified}]{cassandra-src-java-org-apache-cassandra-utils-modified.java}
	...
	\begin{resq}Can automatically selected code be assumed to be well readable?\end{resq} \label{RQ1.1}
	...
	We want to compare the modifications of the proposed heuristics for generating badly readable code to each other. We will investigate whether their results are sufficient for training readability classifiers.
