...
\subsection{Model Training Results} \label{Model training results}
	...
	\begin{table}[h]
		...
		\begin{tabular}{llrrrrrr}
			...
			\midrule
			\textbf{New}        & \textbf{New}     & 91.8 \% & 92.3 \% & 91.3 \% & 91.8 \% & 91.7 \% & 83.6 \% \\
			\textbf{New}        & \textbf{Old}     & 61.9 \% & 63.6 \% & 63.6 \% & 63.6 \% & 63.6 \% & 23.6 \% \\
			\textbf{Old}        & \textbf{Old}     & 53.8 \% & 52.6 \% & 77.8 \% & 65.2 \% & 62.8 \% & 08.7 \% \\
			\textbf{Old}        & \textbf{Old}     & 84.7 \% & 87.7 \% & 82.3 \% & 85.0 \% & 83.7 \% & 70.4 \% \\
			\textbf{New-Old} & \textbf{Old}     & 80.4 \% & 84.0 \% & 73.8 \% & 78.9 \% & 77.2 \% & 60.0 \% \\
			\textbf{New210}     & \textbf{New210}  & 80.9 \% & 82.7 \% & 77.6 \% & 80.2 \% & 78.9 \% & 60.9 \% \\
			\bottomrule
		\end{tabular}
	\end{table}
