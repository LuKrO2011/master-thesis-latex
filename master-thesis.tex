...
\section{Discussion} \label{Discussion}
	...
	Our survey (see \Cref{Pilot Survey}) shows that the mined-and-modified dataset captures readability. The model training results (see \Cref{Model training results}) show that the mined-and-modified dataset captures different aspects of readability than the merged dataset. 	
