...
\section{Introduction} \label{Introduction}
	...
	% TODO Generell: In papern machen wir gern eine Grafik auf die erste Seite, die den Ansatz direkt erklärt. Du hast ja eh listing 1 und 2. Theoretisch könntest du die hier schon einbinden und eine Figure draus machen mit links "good code", rechts "manipulated code"
	...
	We extract methods from the Java classes in these files and label them as badly readable (Assumption \ref{badly-readable-assumption}).
	...
	\begin{itemize}
		...
		\item We propose a novel dataset generation approach and introduce a new readability classification dataset
...
%	Later we will compare our new dataset and generation approach against existing datasets for readability classification.
	...
	We refer to this dataset as the old one.
...
\subsection{Dataset Generation Approach} \label{Dataset Generation Approach}
	...
	While we refer to the merged data set (\autoref{Work on Existing Datasets}) as the old data set, the data set generated by our approach is referred to as the new data set.
	
	Since we ultimately extract methods from code, code snippets and methods are synonyms for our mine-and-modify approach. This is not the case with the old data set, as there a code snippet is not necessarily an entire method.
