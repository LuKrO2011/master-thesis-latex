...
%	In the domain of software development, the significance of code readability cannot be overstated. 
	...
	In a second step, all selected Java files are manipulated so that its code is subsequently less readable. You can find an exemplary result of this in \autoref{lst:rdh-example-method}.
