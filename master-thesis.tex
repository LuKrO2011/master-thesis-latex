...
\textit{3. Results:}
	...
	%			\midrule
	%			None - Methods & 0.9224 \\
	%			None - Newlines Few & $5.23 \times 10^{-6}$ \\
	%			None - Spaces Many & 0.0407 \\
	%			None - Newlines Many & 0.3006 \\
	%			None - Comments Remove & 0.00364 \\
	%			None - Rename & 0.099 \\
	%			None - Newline Instead Of Space & $4.57 \times 10^{-6}$ & True \\
	%			None - Tabs & $3.06 \times 10^{-8}$ \\
	%			None - All7 & $1.80 \times 10^{-7}$ \\
	%			\bottomrule
	%		\end{tabular}
	%	\end{table}
