...
%	In the domain of software development, the significance of code readability cannot be overstated. 
	...
	\begin{listing}[tb]
		...
		\begin{sublisting}{\linewidth}
			...
			\end{minted}
			\caption{The same example as in \autoref{lst:cassandra-src-Java-org-apache-cassandra-utils} but modified for poor readability.}
			\label{lst:cassandra-src-Java-org-apache-cassandra-utils-modified}
		\end{sublisting}
		\caption{Well readable (\autoref{lst:cassandra-src-Java-org-apache-cassandra-utils}) vs. poorly readable (\autoref{lst:cassandra-src-Java-org-apache-cassandra-utils-modified}) code.}
...
%			
	...
	%	To give an example for high vs low readability, consider the code of \autoref{lst:cassandra-src-Java-org-apache-cassandra-utils} from GitHub\curl{https://github.com/apache/cassandra/blob/trunk/src/Java/org/apache/cassandra/utils/HeapUtils.Java}{2023-25-07} and compare it to the code with the same functionality of \autoref{lst:cassandra-src-Java-org-apache-cassandra-utils-modified}. You will notice that the first piece of code is more readable than the second one.
	%	
