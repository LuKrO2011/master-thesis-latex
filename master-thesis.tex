...
%	and consistent guidelines for readability, individual reviewers may not be able to help much” [15]. \cite{buse2009learning}
	...
	% Importance
	It is an essential software quality
	attribute, which may well influence the source code’s maintainability, reusability, portability,
	and reliability (Alawad et al 2019; Sedano 2016). Code with poor readability cause the rise
	in the possibility of introducing bugs (Mannan et al 2018; Scalabrino et al 2018) and bring
	higher potential costs in the subsequent software maintenance and development (Johnson
	et al 2019). Recent research shows that nearly 58% time of developers is spent reading and
	understanding source code (Xia et al 2017). Consequently, if a tool is highly consistent with
	most developers’ perception of code readability, it is prone to speed up the maintenance
	process and avoid costly large-scale reconstruction
	\cite{mi2023graph}
