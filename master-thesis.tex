...
\subsection{Survey} \label{Survey}
	The results of our survey are divided into two parts: The results of the pilot survey (see \Cref{Pilot Survey}), which were used to improve the main survey pre-launch, and the results of the main survey (see \Cref{Prolific Survey}), which were used to answer our research questions (\hyperref[mined-well]{RQ1} and \hyperref[generate-poor]{RQ2}) and to craft our dataset.
...
%	The survey participants were not selected among Java programmers randomly. 
	...
	Both the average value and the mean value are around 12 minutes. The boxplot also shows (see \autoref{fig:survey_times}) that the times are close together and there are no outliers in the time taken.
