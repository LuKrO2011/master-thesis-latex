...
\section{Discussion} \label{Discussion}
	...
	Our survey (see \autoref{Pilot Survey}) showed that mined-and-modified dataset captures readability. The model training results (see \autoref{Model training results}) showed that the mined-and-modified dataset capture different aspects of readability than the merged dataset. 
