...
\section{Research Questions}
	...
	In our new approach for generating training data, we assume that the code from repositories is well readable under certain conditions (\Cref{well-readable-assumption}). To check whether that holds, we use the user study results.
...
\subsection{Threats to Validity}
	...
	The intention of the pilot survey was instead to prepare for the Prolific survey (\Cref{Prolific Survey}).
...
\chapter{Discussion} \label{Discussion}
    ...
    The question arises as to what the different aspects are and whether it is possible to extend \rdh (\Cref{REDEC}) to capture the same aspects. By doing so, we assume we could achieve better evaluation results on the merged dataset than previous models.
