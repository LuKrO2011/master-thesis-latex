...
\textit{1. Experimental setup:}
	...
	Each questionnaire consists of 20 code snippets. Consequently, 400 different code snippets are rated in total. The surveys were configured in such a way that each participant could only take part in one of the questionnaires. You can find the texts of the survey in appendix \ref{TODO}. The questionnaires were crafted as described in section \ref{Construction of Questionnaires}.
