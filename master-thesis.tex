...
\section{Work on Existing Dataset} \label{Work on Existing Datasets}
	...
	First, the available data of 421 rated code snippets is further reduced to 200 code snippets for training. Keep in mind, that a bottleneck of readability classification is the little amount of available data, which makes this a significant loss.
	
	Secondly, evaluation is performed with only those 200 snippets as well. This means, that the model was only evaluated on 50\% of the available data. This is certainly a huge thread to validity. It suggests, that the performance of the model is to a remarkable degree lower when evaluation is performed on random unseen data.
...
\section{Model training results} \label{Model training results}
	...
	\begin{table}[h]
		...
		\begin{tabular}{|c|c|c|c|c|c|c|c|}
			...
			\textbf{All}  		& \textbf{All}  	& 0.847 & 0.877 & 0.823 & 0.837 & 0.628 & 0.704 \\
			
			\textbf{Krod200}  	& \textbf{Krod200}  & 0.809 & 0.827 & 0.776 & 0.802 & 0.789 & 0.609 \\
			\hline
		\end{tabular}
