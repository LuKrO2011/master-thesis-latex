...
%	We performed a statistical test, a one-way ANOVA, and obtained a p-value of $0.40$. This is not less than $5~\%=0.05$. The deviations are not significant.
	We performed an equivalence test using one-way ANOVA~\cite{tabachnick2013using} with an equivalence margin of $0.05$. A difference of $0.05$ is 5~\% of a one-star rating. We obtain a p-value of $0.02$. This is smaller than $5~\%=0.05$. The ratings for the familiarity groups are equivalent to this equivalence margin.
